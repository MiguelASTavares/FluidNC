...
namespace MotorDrivers {
    ...
    void TMC2300Driver::set_registers(bool isHoming) {
        ...
        tmc2300->I_scale_analog(false);  // do not scale via pot
        ...
        tmc2300->pdn_disable(true);  // powerdown pin is disabled. uses ihold.
        ...
        log_verbose("CHOPCONF: " << to_hex(tmc2300->CHOPCONF()));
        log_verbose("COOLCONF: " << to_hex(tmc2300->COOLCONF()));
        log_verbose("TPWMTHRS: " << to_hex(tmc2300->TPWMTHRS()));
        log_verbose("TCOOLTHRS: " << to_hex(tmc2300->TCOOLTHRS()));
        log_verbose("GCONF: " << to_hex(tmc2300->GCONF()));
        log_verbose("PWMCONF: " << to_hex(tmc2300->PWMCONF()));
        log_verbose("IHOLD_IRUN: " << to_hex(tmc2300->IHOLD_IRUN()));
