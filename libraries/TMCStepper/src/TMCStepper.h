...
#include "source/TMC2300_bitfields.h"  //NOTE Added for TMC2300 support
...
public:
    ...
    __attribute__((deprecated("Boolean argument has been deprecated and does nothing"))) TMC2208Stepper(
        uint16_t SW_RX_pin, uint16_t SW_TX_pin, float RS, bool) : TMC2208Stepper(SW_RX_pin, SW_TX_pin, RS, TMC2208_SLAVE_ADDR) {};
#else
