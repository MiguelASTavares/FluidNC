...
bool TMC2300Stepper::nstdby()		{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.nstdby;	}
bool TMC2300Stepper::ms1()			{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.ad0;		}
bool TMC2300Stepper::ms2()			{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.ad1;		}
...
bool TMC2300Stepper::spread_en()	{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.spread_en;}
bool TMC2300Stepper::dir()			{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.dir;		}
bool TMC2300Stepper::comp_a1a2()  	{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.comp_a1a2;}
bool TMC2300Stepper::comp_b1b2()  	{ TMC2300_n::IOIN_t r{0}; r.sr = IOIN(); return r.comp_a1a2;}
...
// W: TCOOLTHRS
uint32_t TMC2300Stepper::TCOOLTHRS() { return TCOOLTHRS_register.sr; }
